...
#define STANDBY_PROTECT_LF_INPUT_Pin GPIO_PIN_3
#define STANDBY_PROTECT_LF_INPUT_GPIO_Port GPIOC
...
#define STANDBY_LF_AMP_OPUTPUT_Pin GPIO_PIN_11
#define STANDBY_LF_AMP_OPUTPUT_GPIO_Port GPIOC
#define SOFTCLIP_LF_AMP_INPUT_Pin GPIO_PIN_12
#define SOFTCLIP_LF_AMP_INPUT_GPIO_Port GPIOC
